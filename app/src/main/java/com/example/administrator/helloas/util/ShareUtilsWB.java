package com.example.administrator.helloas.util;
 ...
 * 微博分享
 */
public class ShareUtilsWB extends AppCompatActivity implements IWeiboHandler.Response {
    public static String APP_KEY = "3336495517";
